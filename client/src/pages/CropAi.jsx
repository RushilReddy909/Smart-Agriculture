    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <Container>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          {/* Results Display */}
          <div
            className="animate-fade-in lg:sticky lg:top-32"
            style={{ animationDelay: "200ms" }}
          >
            <Card
              padding="lg"
              className="text-center min-h-[200px] flex flex-col justify-center items-center bg-white"
            >
              {isSubmitting ? (
                ...
                <div>
                  ...
                  <div className="flex items-center justify-center gap-4">
                    ...
                    <h2 className="heading-secondary text-green-600 capitalize">
                      {prediction}
                    </h2>
                  </div>
                  {imageURL && (
